...
const GRADUATION_REQUIREMENTS: GraduationRequirementDef[] = [
  { name: "English", category: null, requirementType: null, requiredValue: 4, isMeasurable: true },
  { name: "Mathematics", category: null, requirementType: null, requiredValue: 3, isMeasurable: true },
  { name: "Science", category: null, requirementType: null, requiredValue: 3, isMeasurable: true },
  { name: "Biology", category: "Science", requirementType: null, requiredValue: 1, isMeasurable: true },
  { name: "Physical Science", category: "Science", requirementType: null, requiredValue: 1, isMeasurable: true },
  { name: "Social Studies", category: null, requirementType: null, requiredValue: 2, isMeasurable: true },
  { name: "U.S. History", category: "Social Studies", requirementType: null, requiredValue: 1, isMeasurable: true },
  { name: "Government", category: "Social Studies", requirementType: null, requiredValue: 0.5, isMeasurable: true },
  { name: "World History and Geography", category: "Social Studies", requirementType: null, requiredValue: 0.5, isMeasurable: true },
  { name: "Physical Education", category: null, requirementType: null, requiredValue: 3.5, isMeasurable: true },
  { name: "Health", category: null, requirementType: null, requiredValue: 0.5, isMeasurable: true },
  { name: "Consumer Education", category: null, requirementType: null, requiredValue: 0.5, isMeasurable: true },
  { name: "Driver Education", category: null, requirementType: null, requiredValue: 0.5, isMeasurable: true },
  { name: "Fine Arts", category: null, requirementType: null, requiredValue: 1, isMeasurable: true },
  { name: "Electives", category: null, requirementType: null, requiredValue: 18, isMeasurable: true },
  { name: "Additional Credits and P.E.", category: null, requirementType: null, requiredValue: 0, isMeasurable: true },
